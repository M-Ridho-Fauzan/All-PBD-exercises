-- Study Kasus Kelompok 6
-- Malwi Hidayat					- 213040015
-- M.Ridho Fauzan					- 213040036
-- Adnan Rais						- 213040027


-- STRUKTUR DATA

CREATE DATABASE Studi_Retail_Percobaan;

USE Studi_Retail_Percobaan;
...
ADD CONSTRAINT FKRincian_Pe641973
FOREIGN KEY (Diskon_ProdukDiskon_Produk_ID)
REFERENCES Diskon_Produk (Diskon_Produk_ID);

ALTER TABLE Diskon_Produk
ADD CONSTRAINT FKDiskon_Pro616815
FOREIGN KEY (ProdukProduk_ID)
REFERENCES Produk (Produk_ID);

ALTER TABLE Diskon_Produk
ADD CONSTRAINT FKDiskon_Pro543845
FOREIGN KEY (DiskonDiskon_ID)
REFERENCES Diskon (Diskon_ID);

ALTER TABLE Produk
ADD CONSTRAINT FKProduk121103
FOREIGN KEY (SupplierSupplier_ID)
REFERENCES Supplier (Supplier_ID);

ALTER TABLE Rincian_Penjualan
ADD CONSTRAINT FKRincian_Pe767564
FOREIGN KEY (ProdukProduk_ID)
REFERENCES Produk (Produk_ID);

ALTER TABLE Rincian_Penjualan
ADD CONSTRAINT FKRincian_Pe256002
FOREIGN KEY (PenjualanNo_Transaksi)
REFERENCES Penjualan (No_Transaksi);

ALTER TABLE Member
ADD CONSTRAINT FKMember315319
FOREIGN KEY (Jenis_MemberJenis_Member_ID)
REFERENCES Jenis_Member (Jenis_Member_ID);

ALTER TABLE Penjualan
ADD CONSTRAINT FKPenjualan559490
FOREIGN KEY (MemberMember_ID)
REFERENCES Member (Member_ID);

ALTER TABLE Pengiriman
ADD CONSTRAINT FKPengiriman392349
FOREIGN KEY (PenjualanNo_Transaksi)
REFERENCES Penjualan (No_Transaksi);

ALTER TABLE Penjualan
ADD CONSTRAINT FKPenjualan440803
FOREIGN KEY (PegawaiPegawai_ID)
REFERENCES Pegawai (Pegawai_ID);

ALTER TABLE Pengiriman
ADD CONSTRAINT FKPengiriman185161
FOREIGN KEY (PegawaiPegawai_ID)
REFERENCES Pegawai (Pegawai_ID);

ALTER TABLE Pegawai
ADD CONSTRAINT FKPegawai548309
FOREIGN KEY (Atasan_ID)
REFERENCES Pegawai (Pegawai_ID);

ALTER TABLE Pegawai
ADD CONSTRAINT FKPegawai726894
FOREIGN KEY (JabatanJabatan_ID)
REFERENCES Jabatan (Jabatan_ID);

ALTER TABLE Pegawai
ADD CONSTRAINT FKPegawai935947
FOREIGN KEY (GeraiGerai_ID)
...
VALUES
	('1', 'Toko Baru', '20220601', 'Jl. Sukajadi', 'Sukajadi', 'Sukajadi', 'Bandung', 'Jawa Barat');
...
VALUES
	('1', 'Malwi', 'Pria', '19970528', '20221011', 'Jl. Cipedes', 'Sukajadi', 
	'Sukajadi', 'Bandung', 'Jawa Barat', 'S1', 50000000, 'Belum Nikah', 0, 'Manager', '1', '1', '1'),
	('2', 'Adit', 'Pria', '19990210', '20221011', 'Jl. Gerlong', 'Gerlong', 
	'Gerlong', 'Bandung', 'Jawa Barat', 'S1', 28000000, 'Belum Nikah', 0, 'Wakil Manager', '1', '2', '1'),
	('3', 'Gilmen', 'Pria', '20000901', '20221011', 'Jl. Cimahi', 'Cimahi', 
	'Cimahi', 'Bandung', 'Jawa Barat', 'S1', 32000000, 'Belum Nikah', 0, 'Wakil Manager', '1', '2', '1'),
	('4', 'Fauzi', 'Pria', '20010806', '20221011', 'Jl. Cibiru', 'Cibiru', 
	'Cibiru', 'Bandung', 'Jawa Barat', 'S1', 9000000, 'Belum Nikah', 0, 'Kasir', '1', '3', '1'),
	('5', 'Fowaz', 'Pria', '20020101', '20221011', 'Jl. Cileunyi', 'Cileunyi', 
	'Cileunyi', 'Bandung', 'Jawa Barat', 'S1', 6000000, 'Belum Nikah', 0, 'Kasir', '1', '3', '1'),
	('6', 'Lutfi', 'Pria', '20030806', '20221011', 'Jl. Gerlong', 'Gerlong', 
	'Gerlong', 'Bandung', 'Jawa Barat', 'S1', 7000000, 'Belum Nikah', 0, 'Kasir', '1', '3', '1');

INSERT INTO Jabatan(Jabatan_ID, Nama_Jabatan, Deskripsi)
VALUES
	('1', 'Manager', 'Atasan dari seluruh pegawai'),
...
VALUES
	('1', 'Perusahaan A', 'Jl. Cileunyi', 'Cileunyi', 'Cileunyi', 'Bandung', 'Jawa Barat', '081122334455');

	INSERT INTO Produk
VALUES 
	('1', 'Produk A', 'Makanan', '20251031', 200, 'mg', 'Perusahaan A', 10000, '1', '1');

INSERT INTO Diskon(Diskon_ID, Persen_Diskon, Tanggal_Awal_Berlaku, Tanggal_Akhir_Berlaku, MinQty, Deskripsi)
VALUES
	('1', 50, '20221201', '20230201', 5, 'Promo akhir tahun.');

INSERT INTO Diskon_Produk(Diskon_Produk_ID, DiskonDiskon_ID, ProdukProduk_ID)
VALUES
	('1', '1', '1');

-- NOMOR 1.1 (Constraint)
SELECT * FROM dbo.rincian_penjualan;
ALTER TABLE dbo.rincian_penjualan
	ADD total_biaya_per_produk_2 AS (harga_satuan * jumlah_penjualan) - nominal_diskon PERSISTED;
ALTER TABLE dbo.rincian_penjualan
...
/* Kata kunci PERSISTED menetapkan bahwa nilai 
dalam kolom total_biaya_per_produk 
akan disimpan di disk, bukannya dihitung 
ulang setiap kali kolom diakses. */

/* ALTER TABLE dbo.rincian_penjualan 
DROP COLUMN total_biaya_per_produk, 
juga merupakan pernyataan ALTER TABLE 
yang menghapus kolom total_biaya_per_produk 
dari tabel rincian_penjualan. */

-- NOMOR 1.2 (Check Constraint)
...
ALTER TABLE dbo.diskon
	ADD CONSTRAINT CHK_PersenDiskon CHECK(persen_diskon >= 0 AND persen_diskon <= 100 );
...
ALTER TABLE dbo.rincian_penjualan
 ...
 /* o Total_Biaya_Per_Produk pada Rincian_Penjualan */--------------xxxxxxxxxxxx
SELECT * FROM dbo.rincian_penjualan;
ALTER TABLE dbo.rincian_penjualan
	ADD CHECK (total_biaya_per_produk_2 > 0);

 /* o harga_satuan pada Produk */
SELECT * FROM dbo.produk;
ALTER TABLE dbo.produk
 ADD CHECK(harga_satuan > 0);

--NOMOR 1.3 (Unique Constraint)
--Entitas Member
...
--NOMOR 1.4 (Tipe Data Bentukan / User-defined Data Type)
